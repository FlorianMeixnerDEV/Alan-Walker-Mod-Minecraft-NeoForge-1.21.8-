...
import net.florianmeixnerdev.alanwalkermusic.init.*;
...
@Mod("alan_walker_music")
public class AlanWalkerMusicMod {
	public static final Logger LOGGER = LogManager.getLogger(AlanWalkerMusicMod.class);
	public static final String MODID = "alan_walker_music";

	public AlanWalkerMusicMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		AlanWalkerMusicModSounds.REGISTRY.register(modEventBus);
		AlanWalkerMusicModBlocks.REGISTRY.register(modEventBus);
		AlanWalkerMusicModItems.REGISTRY.register(modEventBus);
		AlanWalkerMusicModEntities.REGISTRY.register(modEventBus);
		AlanWalkerMusicModTabs.REGISTRY.register(modEventBus);
		AlanWalkerMusicModMenus.REGISTRY.register(modEventBus);
