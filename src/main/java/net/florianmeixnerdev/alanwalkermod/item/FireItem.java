...
public class FireItem extends Item {
	public FireItem(Item.Properties properties) {
		super(properties.rarity(Rarity.EPIC).jukeboxPlayable(ResourceKey.create(Registries.JUKEBOX_SONG, ResourceLocation.fromNamespaceAndPath(AlanWalkerModMod.MODID, "fire"))));
	}
}