...
public class AlanGuardRenderer extends HumanoidMobRenderer<AlanGuardEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	...
	public AlanGuardRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(AlanGuardEntity entity, HumanoidRenderState state, float partialTicks) {
