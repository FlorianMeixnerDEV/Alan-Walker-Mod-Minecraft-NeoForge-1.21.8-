package net.florianmeixnerdev.alanwalkermod;
...
@Mod("alan_walker_mod")
public class AlanWalkerModMod {
	public static final Logger LOGGER = LogManager.getLogger(AlanWalkerModMod.class);
	public static final String MODID = "alan_walker_mod";

	public AlanWalkerModMod(IEventBus modEventBus) {
